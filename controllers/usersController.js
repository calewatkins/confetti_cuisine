...
module.exports = {
  ...
  register: (req, res, next) => {
    ...
    User.register(newUser, req.body.password, (error, user) => {
      if (user) {
        ...
        req.flash("error", `Failed to create user account because: ${error.messages}.`);
  ...
  update: (req, res, next) => {
    ...
    User.findByIdAndUpdate(userId, {
      ...
      .then(user => {
        req.flash("success", `${user.fullName}'s user account updated successfully`);
